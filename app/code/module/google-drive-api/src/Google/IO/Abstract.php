...
require_once PLUGINS_DIR."google-drive-api/src/Google/IO/Exception.php";
require_once PLUGINS_DIR."google-drive-api/src/Google/Http/CacheParser.php";
require_once PLUGINS_DIR."google-drive-api/src/Google/Http/Request.php";
