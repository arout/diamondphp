...
<div class="white-row">
	...
	<legend style="width: auto;"><strong>Creating</strong> Models</legend>
	<p>
...
$this->model( 'Welcome' );
	...
	<p>
		The above would search the<code>/public/models</code> directory for a file named <strong>Welcome</strong>Model.php. Note that this would only load the model; it does not access or execute any of it's methods. Typically, you would use this in your controller __construct() by assigning it to a variable (i.e.  $model = $this->model( 'Welcome' )). You can load a model and access it's methods directly,
		as shown below:
	</p>
	<pre>
