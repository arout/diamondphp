...
<div class="pull-left padding-right-15 col-xs-12 col-md-3">
    ...
    <div class="col-xs-12 choose-list">
        <div class="pricing-table">
            ...
            <div class="main_pricing padding-bottom-20">
                <div class="inside">
                    <ul>
                        <li><a href="{$smarty.const.BASE_URL}documentation/mvc/controllers">Controllers</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/mvc/models">Models</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/mvc/views">Views</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="main_pricing padding-bottom-20">
                <div class="inside">
                    <ul>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/blocks">Blocks</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/override">Class Overrides</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/cron">Cron Jobs</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/database">Database</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/events">Event Listeners</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/logger">Error Logging</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/loader">File Loading</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/router">Router</a></li>
                        <li><a href="{$smarty.const.BASE_URL}documentation/core/sessions">Sessions</a></li>
                    </ul>
                </div>
            </div>
