  ...
  <div class="row">
      ...
      {if $route eq 'error'}
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-md-12">
              <h6>Email</h6>
              <input type="email" name="email" placeholder="Email address" class="form-control" style="width:100%" required=required>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <h6>Are you human? Solve the math problem below</h6>
    ...
    <div class="col-md-5 white-row">
      ...
      <div class="white-row">
        ...
        <h6>Email Address</h6>
        <form class="input-group" method="post" action="login/forgot_password">
      ...
      <p class="white-row text-center styleBackground"> Need an account? <a href="signup">Register now</a> </p>
    </div>
    <!-- /PASSWORD -->
