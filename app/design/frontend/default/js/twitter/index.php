...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	private $consumer_key = 'ULVDT68AwvvJdOeakv6Yxg';

	// Your Twitter App Consumer Secret
	private $consumer_secret = '6by07eUGkvSVktOmeB16dLALuPTouvF60wyIyK9M';

	// Your Twitter App Access Token
	private $user_token = '1665170233-7qLBTTGjNXJM6B56Ik9Mr16KhaladeMh0NNFvLt';

	// Your Twitter App Access Token Secret
	private $user_secret = 'iMmVLQCjUbhs8f2oHZtHIsWlVsYZ7a2Y0RuDNmKYQ';
	...
	public function fetch() {
		$items       = array("consumer_key", "consumer_secret", "user_token", "user_secret");
		$not_all_set = false;
		...
		$var = ($not_all_set === false ? "vars_set" : "not_set");
		
		echo json_encode(
			array(
				'response' => json_decode($this->getJSON(), true),
				'message' => ($this->debug) ? $this->message : $var
			)
		);
	}
