  ...
  <div class="row top_tiles">
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="tile-stats">
        ...
        <h3>Total Members</h3>
        <p>have joined since site launch</p>
      </div>
    </div>
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="tile-stats">
        <div class="icon"><i class="fa fa-edit"></i></div>
        <div class="count">{$recent_members}</div>
        <h3>New Signups</h3>
    ...
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="tile-stats">
        ...
        <div class="count">{$male_members}</div>
        <h3>Male Members</h3>
        <p>Total men that have signed up</p>
      </div>
    </div>
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
      <div class="tile-stats">
        <div class="icon"><i class="fa fa-female"></i></div>
        <div class="count">{$female_members}</div>
        <h3>Female Members</h3>
        <p>Total women that have signed up</p>
      </div>
    </div>
  </div>
