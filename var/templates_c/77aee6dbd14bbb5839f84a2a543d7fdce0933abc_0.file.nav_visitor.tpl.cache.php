...
/* Smarty version 3.1.30, created on 2017-05-31 15:51:35
  from "/var/www/html/diamond/app/design/frontend/default/views/nav_visitor.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_592f1ec7ad4923_80479765',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '77aee6dbd14bbb5839f84a2a543d7fdce0933abc' => 
    array (
      0 => '/var/www/html/diamond/app/design/frontend/default/views/nav_visitor.tpl',
      1 => 1480653291,
      2 => 'file',
    ),
  ),
...
function content_592f1ec7ad4923_80479765 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '1476834959592f1ec7aabe60_03753955';
?>
								...
								<div class="header-top-dropdown">
									<div class="btn-group dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right dropdown-animation">
											<li>
												<form role="search" class="search-box" method="post" action="<?php echo @constant('BASE_URL');?>
search/results">
...
"><img id="logo" src="<?php echo @constant('BASE_URL');?>
media/default/images/logo.png" alt="DiamondPHP MVC Framework for PHP 7"></a>
								</div>
...
documentation" class="dropdown-toggle">Documentation</a></li>
                          <li class="active"><a href="<?php echo @constant('BASE_URL');?>
download" class="dropdown-toggle">Download</a></li>
                              ...
                              <li>
                                <div class="row">
                                  <div class="col-lg-4 col-md-3 hidden-sm">
                                    ...
                                    <img src="<?php echo @constant('MEDIA_URL');?>
default/images/section-image-3.png" alt="DiamondPHP MVC framework for PHP 7">
                                  </div>
...
forum/"><i class="icon-right-open"></i>Forums</a></li>
                                          <li><a href="<?php echo @constant('BASE_URL');?>
documentation/faq"><i class="icon-right-open"></i>FAQ</a></li>
                                        </ul>
                                      </div>
                                      <div class="col-sm-4">
                                        <div class="divider"></div>
                                        <ul class="menu">
                                          <li><a href="<?php echo @constant('BASE_URL');?>
contact/support"><i class="icon-right-open"></i>Support</a></li>
                                        </ul>
                                      </div>
                                    </div>
                                  </div>
